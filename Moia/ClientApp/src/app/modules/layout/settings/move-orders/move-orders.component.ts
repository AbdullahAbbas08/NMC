...
import { BranshDto, CommitteeIdName, DepartmentDto, FilterData, MainRoleNameId, MainUserDto, NameIdViewModel, OrderTransfereDTO, SwaggerClient, UserDto, UserType, ViewerPaginationOfMainUserDto, ViewerPaginationOfWitness, Witness } from 'src/app/Shared/Services/Swagger/SwaggerClient.service';
...
export class MoveOrdersComponent extends DefaultListComponent<ViewerPaginationOfMainUserDto, MainUserDto> {
  ...
  GetAllMainRoles() {
    this.swagger.apiLookupGetMainRolesDataEntryCommitteeMangerGet().subscribe(
      res => {
        this.AllRoles = res
      }
    )

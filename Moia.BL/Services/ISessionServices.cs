    ...
    public class SessionServices :  ISessionServices
    {
        ...
        public UserType UserType
        {
            get
            {
                ...
                if (claim == null)
                    return UserType.None;
                string unshiftedRole = EncryptHelper.ShiftString(claim.Value, -4);
                string decryptedRole = EncryptHelper.DecryptString(EncryptHelper.DecryptString(unshiftedRole));
                var parsedRole = JsonConvert.DeserializeObject<UserType>(decryptedRole);
                return parsedRole;
            }
        }

...
namespace Moia.DAL.Migrations
{
    ...
    [Migration("20240804081802_AddOrderTransfer")]
    partial class AddOrderTransfer
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moia.Shared.Models.Order", b =>
                {
                    ...
                    b.Property<int?>("OrderTransfereID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Moia.Shared.Models.OrderTransfere", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Moia.Shared.Models.Order", b =>
                {
                    ...
                    b.HasOne("Moia.Shared.Models.OrderTransfere", null)
                        .WithMany("Orders")
                        .HasForeignKey("OrderTransfereID")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Moia.Shared.Models.OrderTransfere", b =>
                {
                    b.HasOne("Moia.Shared.Models.MainUser", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Moia.Shared.Models.MainUser", "ToUser")
                        .WithMany()

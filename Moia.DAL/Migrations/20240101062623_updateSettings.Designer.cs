...
namespace Moia.DAL.Migrations
{
    ...
    [Migration("20240101062623_updateSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moia.Shared.Models.MainUserRole", b =>
                {
                    ...
                    b.HasIndex("BranshId")
                        .IsUnique()
                        .HasFilter("[BranshId] IS NOT NULL");
            ...
            modelBuilder.Entity("Moia.Shared.Models.MainUserRole", b =>
                {
                    b.HasOne("Moia.Shared.Models.MinistryBransh", "Bransh")
                        .WithOne("MangerRoleID")
                        .HasForeignKey("Moia.Shared.Models.MainUserRole", "BranshId")
                        .OnDelete(DeleteBehavior.Restrict);
